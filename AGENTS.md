...
| `tests/` | Pytest test suite with 47 test modules (see `tests/AGENTS.md`) |
...
- Python 3.9+ compatibility required — avoid walrus operator, `match` statements, and `type` aliases
