...
用法：
  python tools/batch_bazi_extract.py --input-dir ./Downloaded/作者名/post
"""
...
def main():
    ...
    post_dir = Path(args.input_dir)
    base_dir = Path(args.base_dir)
    manifest_path = post_dir / args.manifest_name
