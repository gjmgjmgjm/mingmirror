...
- `python -m pytest tests/ -q`：**642 passed**（72 个测试模块）
...
- 新增 `tools/destiny/script_writer.py` 命运剧本与 `tests/test_destiny_script_writer.py`、`tests/test_server_destiny_script.py`
