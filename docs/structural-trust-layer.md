...
| 排盘 | 100% (32/32) | iztro |
| 用神 | 100% (92/92) | 穷通宝鉴 |
| 六亲强弱 | **100% (46/46)** | 杨炎 det（噪声剔除后） |

六亲提升（2026-07）：本气得令 / 子女透干严判 / 透干克泄阈值 2.5 / 母星虚浮不升格；母印·父财·配偶官杀/财·子女官杀或食伤·手足比劫 **双星标签合参**；父星本气根宜在年月、财生官杀于日支作弱（月令得令例外）；月令半合不破父财/印；配偶多透干可抗宫冲坏根。

应期联动：`year_timing_surface.meta.liuqin_bridge` + `structural_critic`（大运/驿马 re-rank，**不断言单年**）。

年份 shortlist LOO（n=44）：production **top1 45.5% / top2 61.4%**，soft-shortlist top2 **69.6%**；firerate 全量 top1 更高但 shortlist 触发过少，产品仍用 production 权重。
