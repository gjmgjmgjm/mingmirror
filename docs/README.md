...
| 六亲强弱 | **~98% (45/46, det, 噪声剔除)** | ✅ 真实(杨炎 gold,det 绕过 LLM) |
...
> - **「结构层 90%」目标框定**:仅指**有独立 gold 的维度**——排盘 100%、用神 100%(穷通 n=92)、**六亲 ~98%(det,n=46)** 均已达成（双星合参 / 父星年月根与财生杀 / 配偶多透干抗冲）。格局/忌神/旺衰**不计入**;事件层是物理天花板。年份 shortlist LOO top1≈45%/top2≈61%（soft top2≈70%），**不是**开放式准确率。
